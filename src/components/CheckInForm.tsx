...
function getQuestionLabel(key: string, ctx: Record<string, boolean>, t: (k: string) => string): string {
  ...
  const labelMap: Record<string, string> = {
    ...
    meditation: "q_meditou",
    prayer: "q_orou",
    breathing: "q_respirou",
    walked: "q_caminhou",
    ran: "q_correu",
    strength_training: "q_musculacao",
    drank_water: "q_agua",
    slept_well: "q_dormiu",
  ...
  useEffect(() => {
    if (existingCheckIn) {
      setForm({
        ...
        meditation: existingCheckIn.meditation ?? false,
        prayer: existingCheckIn.prayer ?? false,
        breathing: existingCheckIn.breathing ?? false,
        ...
        walked: existingCheckIn.walked ?? false,
        ran: existingCheckIn.ran ?? false,
        strength_training: existingCheckIn.strength_training ?? false,
